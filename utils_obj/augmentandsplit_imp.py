# example usage 
# from splitandaugment import *
#autosplit("/content/", weight = (0.7,0.2,0.1))  #/content/ has got /content/labels/ and /content/images
#augment("/content/train/")    #augment is given train directory where /content/train/labels/ & /content/train/images 
# are present
...
def augment(path_to_train):   #path must be given to train!!!!!
